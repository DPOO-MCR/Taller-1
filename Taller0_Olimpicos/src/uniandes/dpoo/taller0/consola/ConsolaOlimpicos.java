...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar la nacionalidad de un atleta");
	...
	{	
		...
		try
	{
		String nombre = (input("Ingrese el nombre del atleta que desea consultar su nacionalidad"));
		Pais pais = calculadora.buscarNacionalidadAtleta(nombre);
		if (pais == null)
		{
			System.out.println("No se encontró un atleta llamado " + nombre);
		}
		else
		{
			System.out.println("El atleta " + nombre + " represento a " + pais);
