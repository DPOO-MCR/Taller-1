...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Consulta la nacionalidad de un atleta dado su nombre.
	 * 
	 * @param nombreAtleta   El nombre del atleta de interés.
	 * @return Retorna un string que dice a que país represento el atleta ingresado por parametro.
	 */
	public Pais buscarNacionalidadAtleta(String nombreAtleta)
	{
		Pais resultado = null;
		Atleta elAtleta = buscarAtleta(nombreAtleta);
		if (elAtleta != null)
